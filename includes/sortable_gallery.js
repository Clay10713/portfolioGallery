...
function checkViewport(){
    ...
    var thumnailWidth = $('.thumbnail_container a.thumbnail:first-child').outerWidth;
    
    if ( photosWidth < thumbnailContainerWidth){
        positionThumbnails();
    }
    if ( (photosWidth - thumbnailContainerWidth) > thumbnailContainerWidth){
        positionThumbnails();
    }
}
...
function sortThumbnails(keyword){
    $('.thumbnail_container a.thumbnail').each(function(){
        ...
        var thumbnailKeywords = $(this).attr('data-keyword');
...
function positionThumbnails(){
    ...
    var thumbnail_R = 0; /* Thumbnail Row  */
    var thumbnail_C = 0; /* Thumbnail Column  */
    ...
    var max_C = Math.floor (containerWidth / thumbnailWidth); /* Calculates how many thumbnails can fit in the photos area  */
    ...
    $('.thumbnail_container a.thumbnail.showMe').each(function(index){
        ...
        /* Resizing the size of the photo container */
